...
//         },
//       };
//       const { data } = await AxiosService.get(`/api/user?search=${query}`, config); // Pass the query to the backend
//       setLoading(false);
//       setSearchResult(data); // Update search results with data received from backend
//     } catch (error) {
//       toast({
